            ...
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-8">
                    ...
                    <div class="bg-white shadow-md rounded-lg overflow-hidden product-card">
                        ...
                        <a href="/ProductController/AddToCart/<%= rs.getString("id")%>" class="inline-block bg-gray-800 text-white py-2 px-4 rounded hover:bg-gray-600 add-to-cart">Add to Cart</a>
                    </div>
                    <%
                        }
                    %>
